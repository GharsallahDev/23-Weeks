...
import torch
import io
from app.services.head_circumference_service import calculate_circumference
...
def calculate_circumference_route():
    try:
        ...
        result = calculate_circumference(image_bytes)
        
        if result is not None:
            return jsonify({"circumference": result})
        else:
